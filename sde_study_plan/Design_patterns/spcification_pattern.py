...
class OrSpecification(Specification):
    ...
    def is_satisfied(self, item):
        print("OrSpecification is satisfied called ", self.specifications)
...
class AndSpecification(Specification):
    ...
    def is_satisfied(self, item):
        print("AndSpecification is satisfied called ", self.specifications)
...
class BetterFilter:
    ...
    def filter(products, specification):
        print("BetterFilter is filtering products")
...
# print("Using Specification Pattern:", color_spec & size_spec)
...
print("Using multiple specifications (RED and MEDIUM or LARGE):", multi_spec)
